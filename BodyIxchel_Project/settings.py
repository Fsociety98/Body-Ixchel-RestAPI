"""
Django settings for BodyIxchel_Project project.
...
SECRET_KEY = '*1jgwk*&#)!iu^3_wzmxrzatl5f2mwe$+y*n_s@%f2j4x=l$lj'
...
ROOT_URLCONF = 'BodyIxchel_Project.urls'
...
WSGI_APPLICATION = 'BodyIxchel_Project.wsgi.application'
